...
**Individual Developer Tier (free):** The Individual Developer Tier is free if you have a [SkillBuilder ID](https://docs.aws.amazon.com/signin/latest/userguide/create-aws_builder_id.html), and it’s a great option to get your started. It supports all the languages offered by CodeWhisperer and reference tracking, but you’re limited to 50 security scans per month.
...
(1) an [AWS BuilderID.](https://docs.aws.amazon.com/signin/latest/userguide/create-aws_builder_id.html)
...
**1.**  Download or Update [**Visual Studio Code.**](https://code.visualstudio.com/)
...
**11.**  Select the appropriate selection. Click **Nex**t if you haven’t created your AWS Builder ID. Alternatively, Click **Already have AWS Builder ID? Sign in.**
